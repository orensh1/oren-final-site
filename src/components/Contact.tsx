        ...
        <div className="flex flex-col lg:flex-row gap-20">
          ...
          >
            ...
            <div className="flex flex-col gap-6">
              <a href="mailto:oren@example.com" className="flex items-center gap-4 text-zinc-300 hover:text-white transition-colors group">
                ...
                <span className="text-lg">oren@example.com</span>
              </a>
              <a href="tel:+972500000000" className="flex items-center gap-4 text-zinc-300 hover:text-white transition-colors group">
                <div className="w-12 h-12 rounded-full bg-zinc-900 flex items-center justify-center group-hover:bg-pink-600 transition-colors">
                    <Phone size={20} />
                </div>
